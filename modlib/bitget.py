    ...
    def fetch_canceled_and_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if marketType == 'spot':
            ...
            if trailing:
                ...
                request['planType'] = planType
                response = self.privateMixGetV2MixOrderOrdersPlanHistory(self.extend(request, params))
                temp_orders = self.safe_value(self.safe_value(response, 'data', {}), 'entrustedList', [])
                if 'orderId' in params and len(temp_orders)==1:
                    params['orderId']=temp_orders[0]['executeOrderId']
